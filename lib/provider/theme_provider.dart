  ...
  static final ThemeData catharsisSignature = ThemeData(
    ...
    extensions: const [
      CustomThemeExtension(
        ...
        categoryChipColor: Color.fromARGB(255, 44, 91, 49),
        categoryChipFontColor: Color.fromRGBO(32, 28, 17, 1),
        preferenceButtonColor: Color.fromARGB(255, 44, 91, 49),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    extensions: const [
      CustomThemeExtension(
        ...
        categoryChipColor: Color.fromRGBO(190, 137, 255, 1),
        preferenceButtonColor: Color.fromRGBO(190, 137, 255, 1),
